...
use NF_FU_VENDOR\Google\Auth\Iam;
use NF_FU_VENDOR\Google\Auth\SignBlobInterface;
use NF_FU_VENDOR\GuzzleHttp\Exception\ClientException;
use NF_FU_VENDOR\GuzzleHttp\Exception\RequestException;
use NF_FU_VENDOR\GuzzleHttp\Exception\ServerException;
...
class GCECredentials extends \NF_FU_VENDOR\Google\Auth\CredentialsLoader implements \NF_FU_VENDOR\Google\Auth\SignBlobInterface
{
     ...
     */
    public function __construct(\NF_FU_VENDOR\Google\Auth\Iam $iam = null, $scope = null)
    {
        $this->iam = $iam;
