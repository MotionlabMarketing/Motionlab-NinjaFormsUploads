...
use NF_FU_VENDOR\GuzzleHttp\Handler\CurlHandler;
use NF_FU_VENDOR\GuzzleHttp\Handler\CurlMultiHandler;
use NF_FU_VENDOR\GuzzleHttp\Handler\Proxy;
use NF_FU_VENDOR\GuzzleHttp\Handler\StreamHandler;
/**
...
function uri_template($template, array $variables)
{
    if (\extension_loaded('uri_template')) {
        ...
        return \NF_FU_VENDOR\uri_template($template, $variables);
