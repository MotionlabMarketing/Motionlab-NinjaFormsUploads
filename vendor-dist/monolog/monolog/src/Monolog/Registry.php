...
class Registry
{
     ...
     */
    public static function addLogger(\NF_FU_VENDOR\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
     ...
     */
    public static function getInstance($name) : \NF_FU_VENDOR\Monolog\Logger
    {
