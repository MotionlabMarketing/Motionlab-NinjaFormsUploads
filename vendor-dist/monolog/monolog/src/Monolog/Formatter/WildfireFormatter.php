 ...
 */
class WildfireFormatter extends \NF_FU_VENDOR\Monolog\Formatter\NormalizerFormatter
{
    /**
     * Translates Monolog log levels to Wildfire levels.
     */
    private $logLevels = [\NF_FU_VENDOR\Monolog\Logger::DEBUG => 'LOG', \NF_FU_VENDOR\Monolog\Logger::INFO => 'INFO', \NF_FU_VENDOR\Monolog\Logger::NOTICE => 'INFO', \NF_FU_VENDOR\Monolog\Logger::WARNING => 'WARN', \NF_FU_VENDOR\Monolog\Logger::ERROR => 'ERROR', \NF_FU_VENDOR\Monolog\Logger::CRITICAL => 'ERROR', \NF_FU_VENDOR\Monolog\Logger::ALERT => 'ERROR', \NF_FU_VENDOR\Monolog\Logger::EMERGENCY => 'ERROR'];
    /**
     * {@inheritdoc}
     */
