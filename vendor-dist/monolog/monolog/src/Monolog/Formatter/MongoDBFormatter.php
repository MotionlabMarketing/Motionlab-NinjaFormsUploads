...
class MongoDBFormatter implements \NF_FU_VENDOR\Monolog\Formatter\FormatterInterface
{
    ...
    {
        $formattedException = ['class' => \NF_FU_VENDOR\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => (int) $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine()];
