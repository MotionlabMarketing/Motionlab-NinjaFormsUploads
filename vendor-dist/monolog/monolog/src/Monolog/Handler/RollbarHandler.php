...
use NF_FU_VENDOR\Rollbar\RollbarLogger;
use Throwable;
...
class RollbarHandler extends \NF_FU_VENDOR\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(\NF_FU_VENDOR\Rollbar\RollbarLogger $rollbarLogger, $level = \NF_FU_VENDOR\Monolog\Logger::ERROR, bool $bubble = \true)
    {
