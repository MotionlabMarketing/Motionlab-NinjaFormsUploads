...
class DeduplicationHandler extends \NF_FU_VENDOR\Monolog\Handler\BufferHandler
{
     ...
     */
    public function __construct(\NF_FU_VENDOR\Monolog\Handler\HandlerInterface $handler, ?string $deduplicationStore = null, $deduplicationLevel = \NF_FU_VENDOR\Monolog\Logger::ERROR, int $time = 60, bool $bubble = \true)
    {
