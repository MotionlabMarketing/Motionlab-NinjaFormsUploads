 ...
 */
abstract class AbstractSyslogHandler extends \NF_FU_VENDOR\Monolog\Handler\AbstractProcessingHandler
{
    protected $facility;
    /**
     * Translates Monolog log levels to syslog log priorities.
     */
    protected $logLevels = [\NF_FU_VENDOR\Monolog\Logger::DEBUG => \LOG_DEBUG, \NF_FU_VENDOR\Monolog\Logger::INFO => \LOG_INFO, \NF_FU_VENDOR\Monolog\Logger::NOTICE => \LOG_NOTICE, \NF_FU_VENDOR\Monolog\Logger::WARNING => \LOG_WARNING, \NF_FU_VENDOR\Monolog\Logger::ERROR => \LOG_ERR, \NF_FU_VENDOR\Monolog\Logger::CRITICAL => \LOG_CRIT, \NF_FU_VENDOR\Monolog\Logger::ALERT => \LOG_ALERT, \NF_FU_VENDOR\Monolog\Logger::EMERGENCY => \LOG_EMERG];
    /**
     ...
     */
    public function __construct($facility = \LOG_USER, $level = \NF_FU_VENDOR\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    {
        return new \NF_FU_VENDOR\Monolog\Formatter\LineFormatter('%channel%.%level_name%: %message% %context% %extra%');
    }
}
