...
class PushoverHandler extends \NF_FU_VENDOR\Monolog\Handler\SocketHandler
{
     ...
     */
    public function __construct(string $token, $users, ?string $title = null, $level = \NF_FU_VENDOR\Monolog\Logger::CRITICAL, bool $bubble = \true, bool $useSSL = \true, $highPriorityLevel = \NF_FU_VENDOR\Monolog\Logger::CRITICAL, $emergencyLevel = \NF_FU_VENDOR\Monolog\Logger::EMERGENCY, int $retry = 30, int $expire = 25200)
    {
    ...
    private function buildContent(array $record) : string
    {
        ...
        $message = \NF_FU_VENDOR\Monolog\Utils::substr($message, 0, $maxMessageLength);
    ...
    {
        $this->highPriorityLevel = \NF_FU_VENDOR\Monolog\Logger::toMonologLevel($value);
        return $this;
    }
    public function setEmergencyLevel($value) : self
    {
        $this->emergencyLevel = \NF_FU_VENDOR\Monolog\Logger::toMonologLevel($value);
        return $this;
    }
    /**
