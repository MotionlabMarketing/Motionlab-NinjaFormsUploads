 ...
 */
namespace NF_FU_VENDOR\Monolog\Handler\Slack;
...
class SlackRecord
{
    ...
    public function __construct(?string $channel = null, ?string $username = null, bool $useAttachment = \true, ?string $userIcon = null, bool $useShortAttachment = \false, bool $includeContextAndExtra = \false, array $excludeFields = array(), \NF_FU_VENDOR\Monolog\Formatter\FormatterInterface $formatter = null)
    {
    ...
    public function stringify(array $fields) : string
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \NF_FU_VENDOR\Monolog\Utils::jsonEncode($normalized, \JSON_PRETTY_PRINT | \NF_FU_VENDOR\Monolog\Utils::DEFAULT_JSON_FLAGS) : \NF_FU_VENDOR\Monolog\Utils::jsonEncode($normalized, \NF_FU_VENDOR\Monolog\Utils::DEFAULT_JSON_FLAGS);
    }
    /**
    ...
    public function setFormatter(?\NF_FU_VENDOR\Monolog\Formatter\FormatterInterface $formatter = null) : self
    {
