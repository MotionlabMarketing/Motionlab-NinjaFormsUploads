 ...
 */
class FilterHandler extends \NF_FU_VENDOR\Monolog\Handler\Handler implements \NF_FU_VENDOR\Monolog\Handler\ProcessableHandlerInterface, \NF_FU_VENDOR\Monolog\ResettableInterface, \NF_FU_VENDOR\Monolog\Handler\FormattableHandlerInterface
{
     ...
     */
    public function __construct($handler, $minLevelOrList = \NF_FU_VENDOR\Monolog\Logger::DEBUG, $maxLevel = \NF_FU_VENDOR\Monolog\Logger::EMERGENCY, bool $bubble = \true)
    {
     ...
     */
    public function setAcceptedLevels($minLevelOrList = \NF_FU_VENDOR\Monolog\Logger::DEBUG, $maxLevel = \NF_FU_VENDOR\Monolog\Logger::EMERGENCY) : self
    {
