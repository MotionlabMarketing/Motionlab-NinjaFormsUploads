...
use NF_FU_VENDOR\Aws\Sqs\SqsClient;
 ...
 */
class SqsHandler extends \NF_FU_VENDOR\Monolog\Handler\AbstractProcessingHandler
{
    ...
    /** @var string */
    private $queueUrl;
    public function __construct(\NF_FU_VENDOR\Aws\Sqs\SqsClient $sqsClient, string $queueUrl, $level = \NF_FU_VENDOR\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    protected function write(array $record) : void
    {
        ...
        if (\strlen($messageBody) >= static::MAX_MESSAGE_SIZE) {
            $messageBody = \NF_FU_VENDOR\Monolog\Utils::substr($messageBody, 0, static::HEAD_MESSAGE_SIZE);
        }
