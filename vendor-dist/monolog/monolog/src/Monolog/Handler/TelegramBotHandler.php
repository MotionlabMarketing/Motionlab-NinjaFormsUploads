 ...
 */
class TelegramBotHandler extends \NF_FU_VENDOR\Monolog\Handler\AbstractProcessingHandler
{
     ...
     * @inheritDoc
     */
    public function __construct(string $apiKey, string $channel, $level = \NF_FU_VENDOR\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    protected function send(string $message) : void
    {
        ...
        $result = \NF_FU_VENDOR\Monolog\Handler\Curl\Util::execute($ch);
