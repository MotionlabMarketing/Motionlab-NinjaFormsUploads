...
use NF_FU_VENDOR\Monolog\Formatter\ChromePHPFormatter;
...
class ChromePHPHandler extends \NF_FU_VENDOR\Monolog\Handler\AbstractProcessingHandler
{
    ...
    protected function send() : void
    {
        ...
        if (\strlen($data) > 3 * 1024) {
            self::$overflowed = \true;
            $record = ['message' => 'Incomplete logs, chrome header size limit reached', 'context' => [], 'level' => \NF_FU_VENDOR\Monolog\Logger::WARNING, 'level_name' => \NF_FU_VENDOR\Monolog\Logger::getLevelName(\NF_FU_VENDOR\Monolog\Logger::WARNING), 'channel' => 'monolog', 'datetime' => new \DateTimeImmutable(), 'extra' => []];
