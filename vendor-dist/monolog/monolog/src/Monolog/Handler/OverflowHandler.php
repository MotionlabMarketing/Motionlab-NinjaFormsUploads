 ...
 */
class OverflowHandler extends \NF_FU_VENDOR\Monolog\Handler\AbstractHandler implements \NF_FU_VENDOR\Monolog\Handler\FormattableHandlerInterface
{
    /** @var HandlerInterface */
    private $handler;
    /** @var int[] */
    private $thresholdMap = [\NF_FU_VENDOR\Monolog\Logger::DEBUG => 0, \NF_FU_VENDOR\Monolog\Logger::INFO => 0, \NF_FU_VENDOR\Monolog\Logger::NOTICE => 0, \NF_FU_VENDOR\Monolog\Logger::WARNING => 0, \NF_FU_VENDOR\Monolog\Logger::ERROR => 0, \NF_FU_VENDOR\Monolog\Logger::CRITICAL => 0, \NF_FU_VENDOR\Monolog\Logger::ALERT => 0, \NF_FU_VENDOR\Monolog\Logger::EMERGENCY => 0];
    /**
     ...
     * @param bool             $bubble
     */
    public function __construct(\NF_FU_VENDOR\Monolog\Handler\HandlerInterface $handler, array $thresholdMap = [], int $level = \NF_FU_VENDOR\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
