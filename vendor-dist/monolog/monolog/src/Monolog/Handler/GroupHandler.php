 ...
 */
class GroupHandler extends \NF_FU_VENDOR\Monolog\Handler\Handler implements \NF_FU_VENDOR\Monolog\Handler\ProcessableHandlerInterface, \NF_FU_VENDOR\Monolog\ResettableInterface
{
    ...
    public function __construct(array $handlers, bool $bubble = \true)
    {
        foreach ($handlers as $handler) {
            if (!$handler instanceof \NF_FU_VENDOR\Monolog\Handler\HandlerInterface) {
