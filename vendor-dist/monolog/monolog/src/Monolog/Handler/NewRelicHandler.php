...
class NewRelicHandler extends \NF_FU_VENDOR\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($level = \NF_FU_VENDOR\Monolog\Logger::ERROR, bool $bubble = \true, ?string $appName = null, bool $explodeArrays = \false, ?string $transactionName = null)
    {
    ...
    protected function setNewRelicParameter(string $key, $value) : void
    {
        if (null === $value || \is_scalar($value)) {
            ...
            \newrelic_add_custom_parameter($key, \NF_FU_VENDOR\Monolog\Utils::jsonEncode($value, null, \true));
        }
    }
    /**
     * {@inheritDoc}
