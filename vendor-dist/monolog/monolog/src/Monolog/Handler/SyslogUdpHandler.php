...
use NF_FU_VENDOR\Monolog\Handler\SyslogUdp\UdpSocket;
/**
...
class SyslogUdpHandler extends \NF_FU_VENDOR\Monolog\Handler\AbstractSyslogHandler
{
     ...
     */
    public function __construct(string $host, int $port = 514, $facility = \LOG_USER, $level = \NF_FU_VENDOR\Monolog\Logger::DEBUG, bool $bubble = \true, string $ident = 'php', int $rfc = self::RFC5424)
    {
     ...
     */
    public function setSocket(\NF_FU_VENDOR\Monolog\Handler\SyslogUdp\UdpSocket $socket) : self
    {
        $this->socket = $socket;
        return $this;
    }
