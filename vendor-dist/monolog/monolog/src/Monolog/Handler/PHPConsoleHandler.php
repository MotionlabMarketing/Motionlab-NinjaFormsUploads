...
use NF_FU_VENDOR\PhpConsole\Connector;
use NF_FU_VENDOR\PhpConsole\Handler as VendorPhpConsoleHandler;
use NF_FU_VENDOR\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends \NF_FU_VENDOR\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(array $options = [], ?\NF_FU_VENDOR\PhpConsole\Connector $connector = null, $level = \NF_FU_VENDOR\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
     ...
     */
    private function initConnector(?\NF_FU_VENDOR\PhpConsole\Connector $connector = null) : \NF_FU_VENDOR\PhpConsole\Connector
    {
        if (!$connector) {
    ...
    public function getConnector() : \NF_FU_VENDOR\PhpConsole\Connector
    {
