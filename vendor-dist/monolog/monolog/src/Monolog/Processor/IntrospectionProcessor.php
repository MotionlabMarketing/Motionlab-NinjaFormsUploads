 ...
 */
class IntrospectionProcessor implements \NF_FU_VENDOR\Monolog\Processor\ProcessorInterface
{
    private $level;
     ...
     */
    public function __construct($level = \NF_FU_VENDOR\Monolog\Logger::DEBUG, array $skipClassesPartials = [], int $skipStackFramesCount = 0)
    {
