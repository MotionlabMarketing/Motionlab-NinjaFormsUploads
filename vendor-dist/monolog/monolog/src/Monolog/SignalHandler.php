...
class SignalHandler
{
    ...
    public function registerSignalHandler($signo, $level = \NF_FU_VENDOR\Psr\Log\LogLevel::CRITICAL, bool $callPrevious = \true, bool $restartSyscalls = \true, ?bool $async = \true) : self
    {
    ...
    public function handleSignal($signo, array $siginfo = null) : void
    {
        ...
        $level = $this->signalLevelMap[$signo] ?? \NF_FU_VENDOR\Psr\Log\LogLevel::CRITICAL;
